...
from .detector import DetectionResult, Severity
...
def generate_markdown_report(
    ...
    if not vulns:
        ...
        for _i, v in enumerate(sorted_vulns, start=1):
            lines.extend([
    ...
    lines.extend([
        "",
        "---",
        "*Generated by Mantle-Audit-AI v0.1.0*",
    ])
